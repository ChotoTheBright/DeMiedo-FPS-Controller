...
#var blood_spray = preload("res://assets/effects/BloodSpray.tscn")
#var gibs = preload("res://assets/effects/Gibs.tscn")
onready var monster = get_parent() #this is to refrence the monster in question
onready var blood_spray = preload("res://assets/effects/BloodSpray.tscn")
onready var gibs = preload("res://assets/effects/Gibs.tscn")
...
func spawn_gibs():
	...
	gibs_inst.global_transform.origin = get_parent().get_node("Monster/Armature/Skeleton/Bone/GS").global_transform.origin #HEREYAFOOL#
